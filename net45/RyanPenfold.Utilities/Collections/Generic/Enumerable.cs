...
namespace RyanPenfold.Utilities.Collections.Generic
{
    ...
    {
        //public static string Parse(this System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<string, Microsoft.Extensions.Primitives.StringValues>> values)
        //{
        //    if (values == null)
        //    {
        ...
        //    {
        //        result.AppendWithDelimiter($"{keyValuePair.Key}={keyValuePair.Value}", "&");
        //    }
