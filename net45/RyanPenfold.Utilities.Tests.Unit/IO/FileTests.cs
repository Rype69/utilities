...
namespace RyanPenfold.Utilities.Tests.Unit.IO
{
    ...
    public class FileTests
    {
        ...
        public void Delete()
        {
            ...
            var path = System.IO.Path.Combine(Utilities.IO.UncPath.GetApplicationDirectory(), "NewFile.txt");
        ...
        {
            // The path to the new file
            var path = System.IO.Path.Combine(Utilities.IO.UncPath.GetApplicationDirectory(), "NewFileWithException.txt");
